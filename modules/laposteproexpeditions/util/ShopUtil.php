...
class ShopUtil
{
    ...
    public static function getShopContext()
    {
        ...
        self::$multistore = \Shop::isFeatureActive();
    }
    ...
    private static function getCurrentShopId()
    {
        ...
        if ($shopId === null) {
            $shopId = \LaPosteProExpeditions::getInstance()->getContext()->shop->id;
        }
    ...
    {
        $shopId = \Shop::getContextShopGroupID();

        if ($shopId === null) {
            $shopId = \LaPosteProExpeditions::getInstance()->getContext()->shop->id_shop_group;
        }
