...
class MiscUtil
{
    ...
    public static function notEmptyOrNull($array, $property = null)
    {
        ...
        return null !== $isSet && '' !== $isSet ? $isSet : null;
    }

    /**
     * Cast to float if not null.
     *
     * @param string|null $string string to cast
     *
     * @return float
     */
    public static function toFloatOrNull($string)
    {
        return null !== $string ? (float) $string : null;
    }

    /**
     * Return base64 encoded value if not null.
     *
     * @param mixed|null $value value to be encoded
     *
     * @return mixed $value
     */
