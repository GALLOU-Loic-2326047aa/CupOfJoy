{if $displayedFacets|count}
    <div id="search_filters" class="nespresso-search-filters">
        ...
        {foreach from=$displayedFacets item="facet"}
            <section class="facet clearfix nespresso-facet" data-type="{$facet.type}" data-name="{$facet.label}">
                    ...
                    {block name='facet_item_other'}
                        <ul id="facet_{$_expand_id}" class="collapse{if !$_collapse} in{/if}">
                            {foreach from=$facet.filters key=filter_key item="filter"}
                                ...
                                <li>
                                    <label class="facet-label{if $filter.active} active {/if} nespresso-facet-label" for="facet_input_{$_expand_id}_{$filter_key}">
                                        {if $facet.multipleSelectionAllowed}
                                            <span class="custom-checkbox nespresso-facet-checkbox">
                                    <input
                        ...
                        {else}
                          <span class="checkmark"><i class="material-icons rtl-no-flip checkbox-checked">✓</i></span>
                        {/if}
                        </span>
                                        {else}
